...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>\n      Custom Voice\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-card>\n    <ion-card-header>\n      <ion-card-subtitle>Get Started</ion-card-subtitle>\n      <ion-card-title>Welcome to Custom Voice</ion-card-title>\n    </ion-card-header>\n    <ion-card-content>\n      <ion-list lines=\"none\">\n        <ion-item><ion-icon name=\"information-circle-outline\"></ion-icon><a target=\"_blank\" rel=\"noopener\" href=\"https://customvoice.ai\">Azure Custom Voice</a></ion-item>\n        <ion-item><ion-icon name=\"information-circle-outline\"></ion-icon><a target=\"_blank\" rel=\"noopener\" href=\"https://azure.microsoft.com/try/cognitive-services/\">Speech Services key</a></ion-item>\n        <ion-item><ion-icon name=\"information-circle-outline\"></ion-icon><a target=\"_blank\" rel=\"noopener\" href=\"https://github.com/boltomli/custom-voice-api\">Find source code of the app</a></ion-item>\n      </ion-list>\n    </ion-card-content>\n  </ion-card>\n\n  <ion-card [class.hide]=\"!token\">\n    <ion-card-header>\n      <ion-card-subtitle>Endpoints</ion-card-subtitle>\n    </ion-card-header>\n    <ion-list>\n      <ion-list-header>Endpoint</ion-list-header>\n      <ion-item *ngFor=\"let item of endpoints\" (click)=\"selectEndpoint(item);\">\n          {{ item.endpointUrls.Ssml }} - {{ item.name }} - {{ item.locale }} - {{ item.description }}\n      </ion-item>\n    </ion-list>\n    <ion-card-subtitle>Text to Speak</ion-card-subtitle>\n    <ion-textarea [(ngModel)]=\"text\" placeholder=\"Input text to speak here\"></ion-textarea>\n    <ion-button expand=\"block\" (click)=\"speakText();\">Test</ion-button>\n  </ion-card>\n\n  <ion-card>\n    <ion-card-header>\n      <ion-card-subtitle>Set valid key and region</ion-card-subtitle>\n    </ion-card-header>\n    <ion-list>\n      <ion-list-header>Region</ion-list-header>\n      <ion-select [(ngModel)]=\"region\">\n        <ion-select-option value=\"westus\">westus</ion-select-option>\n      </ion-select>\n    </ion-list>\n    <ion-item>\n      <ion-label position=\"floating\"><ion-icon name=\"key\"></ion-icon> Key</ion-label>\n      <ion-input [(ngModel)]=\"key\" type=\"text\" clearInput></ion-input>\n    </ion-item>\n    <ion-button expand=\"block\" (click)=\"saveSettings();\">Save</ion-button>\n  </ion-card>\n</ion-content>\n"
...
module.exports = ".hide {\n  display: none; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _ionic_native_media_ngx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic-native/media/ngx */ "./node_modules/@ionic-native/media/ngx/index.js");
/* harmony import */ var xmlbuilder_lib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! xmlbuilder/lib */ "./node_modules/xmlbuilder/lib/index.js");
/* harmony import */ var xmlbuilder_lib__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(xmlbuilder_lib__WEBPACK_IMPORTED_MODULE_6__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    function HomePage(platform, storage, http, toastCtrl, file, media) {
        var _this = this;
    ...
    HomePage.prototype.getModels = function () {
        var _this = this;
        ...
        this.http.post(this.tokenUrl, '', {
            ...
            _this.token = token;
            _this.modelUrl = "https://" + _this.region + ".cris.ai/api/texttospeech/v2.0/models";
            _this.http.get(_this.modelUrl, {
                headers: { 'Ocp-Apim-Subscription-Key': _this.key },
                responseType: 'json'
    ...
    HomePage.prototype.selectModel = function (model) {
        this.voice = model.id;
    };
    HomePage.prototype.getEndpoints = function () {
        var _this = this;
        this.tokenUrl = "https://" + this.region + ".api.cognitive.microsoft.com/sts/v1.0/issueToken";
        this.http.post(this.tokenUrl, '', {
            headers: { 'Ocp-Apim-Subscription-Key': this.key },
            ...
            _this.token = token;
            _this.endpointUrl = "https://" + _this.region + ".cris.ai/api/texttospeech/v2.0/endpoints";
            _this.http.get(_this.endpointUrl, {
                headers: { 'Ocp-Apim-Subscription-Key': _this.key },
                responseType: 'json'
    ...
    HomePage.prototype.selectEndpoint = function (endpoint) {
    ...
    HomePage.prototype.speakText = function () {
        ...
        if (!this.text) {
            ...
            var ssml_doc = xmlbuilder_lib__WEBPACK_IMPORTED_MODULE_6___default.a.create('speak')
                .att('version', '1.0')
            ...
            this.http.post(this.endpoint, ssml_doc, {
                ...
                if (_this.platform.is('hybrid') && !_this.platform.is('electron')) {
                    _this.file.resolveLocalFilesystemUrl(_this.file.dataDirectory).then(function (entry) {
                        _this.file.writeFile(entry.toInternalURL(), 'synth.wav', synth, { replace: true }).then(function (fileEntry) {
                    ...
                    audioContext_1.decodeAudioData(synth).then(function (buffer) {
                        var src = audioContext_1.createBufferSource();
                        src.buffer = buffer;
                        src.connect(audioContext_1.destination);
                        src.start(0);
                    }, function (err) {
                        _this.toastCtrl.create({
                            message: err.message,
    ...
    HomePage = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
            ...
            _ionic_native_media_ngx__WEBPACK_IMPORTED_MODULE_5__["Media"]])
    ], HomePage);
    return HomePage;
}());
